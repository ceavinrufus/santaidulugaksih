...
public class FoodAdapter implements JsonSerializer<Food>, JsonDeserializer<Food> {
    @Override
    public JsonElement serialize(Food food, java.lang.reflect.Type type,
        ...
        result.add("properties", jsonSerializationContext.serialize(food, food.getClass()));
        return result;
    }
