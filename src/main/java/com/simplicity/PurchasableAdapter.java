...
public class PurchasableAdapter implements JsonSerializer<Purchasable>, JsonDeserializer<Purchasable> {
    ...
    public JsonElement serialize(Purchasable purchasable, java.lang.reflect.Type type,
        ...
        result.add("properties", jsonSerializationContext.serialize(purchasable, purchasable.getClass()));
        return result;
    }

    @Override
    public Purchasable deserialize(JsonElement jsonElement, java.lang.reflect.Type type,
