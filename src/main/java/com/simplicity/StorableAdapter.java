...
public class StorableAdapter implements JsonSerializer<Storable>, JsonDeserializer<Storable> {
    @Override
    public JsonElement serialize(Storable storable, java.lang.reflect.Type type,
        ...
        result.add("properties", jsonSerializationContext.serialize(storable, storable.getClass()));
        return result;
    }
