...
// public class FurnitureAdapter implements JsonSerializer<Furniture>,
// JsonDeserializer<Furniture> {
// @Override
// public JsonElement serialize(Furniture furniture, java.lang.reflect.Type
// type,
// JsonSerializationContext jsonSerializationContext) {
// JsonObject result = new JsonObject();
// result.add("type", new JsonPrimitive(furniture.getClass().getSimpleName()));
// result.add("properties", jsonSerializationContext.serialize(furniture,
// furniture.getClass()));
// return result;
// }

// @Override
// public Furniture deserialize(JsonElement jsonElement, java.lang.reflect.Type
// type,
...
// try {
// return jsonDeserializationContext.deserialize(properties,
